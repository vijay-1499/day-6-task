...
var details = new a ("The Dark Night","Warner Brothers","pg-13")
var a1 = details;
console.log(a1.title)
console.log(a1.studio)
console.log(a1.rating)


// //2.b)The constructor for the class Movie will set the class property rating to "PG" as default when no rating is provided.
class Movie {
...
// //4.d);Write a piece of code that creates an instance of the class Movie with the title “Casino Royale”, the studio “Eon Productions”, and the rating “PG­13”
class Movie {
  constructor(title, studio, rating) {
    this.title = title;
    this.studio = studio;
